...
public class Main {
	...
	public static void main(String[] args) {
		...
		p.new Condition(new Double[]{0.0,0.0,0.0,1.0}, RELATION.GREATER_OR_EQUAL, 0);
		p.new Condition(new Double[]{0.0,1.0,0.0,0.0}, RELATION.SMALLER_OR_EQUAL, 0);
		p.new Condition(new Double[]{0.0,0.0,1.0,0.0}, RELATION.EQUAL, 0);
